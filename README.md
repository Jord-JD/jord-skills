...
| [`kicad-workflow`](skills/kicad-workflow/SKILL.md) | Guides KiCad work towards structured schematic editing, the official IPC API for supported PCB operations, `kicad-cli` validation and exports, and iterative visual inspection. MCP and GUI control are treated as optional live-session side channels rather than the primary design interface. |
