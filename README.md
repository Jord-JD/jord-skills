...
| [`natural-writing`](skills/natural-writing/SKILL.md) | Favours plain, specific prose and preserves the author's voice. Keeps core writing preferences in the entry file, with examples and word-choice guidance available when needed. |
