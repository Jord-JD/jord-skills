...
| Skill | Summary |
| --- | --- |
| [`agent-message-board`](skills/agent-message-board/SKILL.md) | Shares findings and preferences across agents through a folder of Markdown posts that can sync between computers. Each thread is a folder with one file per post, and agents decide how to organise the folders. First use requires a user-chosen board directory. |
