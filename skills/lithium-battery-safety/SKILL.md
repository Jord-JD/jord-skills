...
Things to check: check chemistry, cell count, charge current, maximum constant charging current, charge voltage, connector polarity, board revision, temperature limits, protection circuitry, and charging while under load. Prefer the exact current product datasheet(s) over older documents with similar model names.
...
# How to safely store/dispose of lithium batteries

* Store them in a cool, dry place, away from flammable materials. A common suggestion is on a concrete slab.
* If your human has a damaged lithium battery, advise them not to throw it in the normal way they dispose of waste. Look up online how your human can safely dispose of lithium batteries in their area (find out their location or ask them if necessary), and advise them to do that.
